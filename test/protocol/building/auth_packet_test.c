...
TEST test_trilogy_build_auth_switch_response_packet_clear_with_pass_and_database()
{
    trilogy_builder_t builder;
    trilogy_buffer_t buff;
    int err = trilogy_buffer_init(&buff, 1);
    ...
    err = trilogy_build_auth_switch_response_packet(&builder, pass, strlen(pass), "mysql_clear_password", scramble, true);
    ASSERT_OK(err);

    static const uint8_t expected[] = {
        0x07, 0x00, 0x00, 0x01, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
int build_auth_packet_test()
{
    ...
    RUN_TEST(test_trilogy_build_auth_switch_response_packet_clear_with_pass_and_database);
    return 0;
}
